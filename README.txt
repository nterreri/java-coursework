...
2. Runnable jar file
3. Javadoc (inside the workspace)
4. A list of all features implemented
5. Originally, also contained a video demonstration (which was surprisingly difficult to produce, and has been removed)
6. The present README

The JAR file has been tested to work on both linux and Windows 7.
...
but it should be able to self-extract sample versions should they be missing
